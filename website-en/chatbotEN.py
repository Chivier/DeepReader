...
st.title(f"A deep reading of - {selected_book}")
...
if st.button("Start deep reading", key="start_reading"):
    st.session_state.messages = []
    book_prompt = open(f"website/book_prompt/{selected_book}.md", "r").read()
    ...
    with st.spinner("Preparing deep reading..."):
        ...
        st.session_state.messages.append({"role": "user", "content": "Hello, let us talk about " + selected_book + "."})
        st.session_state.message1.append({"role": "user", "content": "Hello, let us talk about " + selected_book + "."})
        st.session_state.message2.append({"role": "user", "content": "Hello, let us talk about " + selected_book + "."})
        st.session_state.message3.append({"role": "user", "content": "Hello, let us talk about " + selected_book + "."})
        ...
        style_response1 = style_prompt(st.session_state.initial_prompt1["style_guide"], st.session_state.initial_prompt1["preference_type"], st.session_state.initial_prompt1["preference_name"], "Hello, let us talk about " + selected_book + ".")
